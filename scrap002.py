# https://medium.com/@havidr/how-to-extract-data-with-python-beautifulsoup-80a5efddb3d1
# https://github.com/havidri/Scraping-Carousell/blob/main/extraction_data.py
import requests, csv
